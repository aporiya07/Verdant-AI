...
const MOCK_USERS = [
  { id: '1', name: 'Priya Sharma', city: 'Bengaluru', monthlyKg: 82.4, xp: 2200, avatar: '🌺' },
  { id: '2', name: 'Arjun Menon', city: 'Kochi', monthlyKg: 91.1, xp: 1850, avatar: '🌿' },
  { id: '3', name: 'Kavya Nair', city: 'Chennai', monthlyKg: 105.7, xp: 1640, avatar: '🎋' },
  { id: '4', name: 'Rohan Gupta', city: 'Delhi', monthlyKg: 118.3, xp: 1420, avatar: '🌳' },
  { id: '5', name: 'Ananya Iyer', city: 'Mumbai', monthlyKg: 124.9, xp: 1380, avatar: '🍃' },
  { id: '6', name: 'Vikram Reddy', city: 'Hyderabad', monthlyKg: 138.2, xp: 1105, avatar: '🌱' },
  { id: '7', name: 'Sneha Joshi', city: 'Pune', monthlyKg: 142.6, xp: 990, avatar: '🌻' },
  { id: '8', name: 'Dev Agarwal', city: 'Ahmedabad', monthlyKg: 151.3, xp: 780, avatar: '🌾' },
]
    ...
    <div className="space-y-6">
      ...
      <GlassCard strong className="p-5">
        ...
        <div className="mt-4 p-3 rounded-xl" style={{ background: 'rgba(46,204,122,0.08)', border: '1px solid rgba(46,204,122,0.15)' }}>
          <p className="text-xs text-center text-[rgba(245,240,232,0.7)]">
            India's per-capita footprint is <span className="text-[#2ECC7A] font-semibold">2.5× lower</span> than the global average.
      ...
      <div className="space-y-2">
        ...
        {filtered.map((user, idx) => {
          const { icon } = getLevelInfo(user.xp)
          const isTop3 = idx < 3
