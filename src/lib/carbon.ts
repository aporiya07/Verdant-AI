...
export const ACTIVITY_TEMPLATES: ActivityTemplate[] = [
  // Transport
  { id: 'metro', label: 'Metro commute', category: 'transport', icon: '🚇', defaultCO2: 0, unit: 'km', prompt: 'How many km?' },
  { id: 'city_bus', label: 'City bus (BEST/BMTC/DTC)', category: 'transport', icon: '🚌', defaultCO2: 0, unit: 'km', prompt: 'How many km?' },
  { id: 'auto', label: 'Auto rickshaw', category: 'transport', icon: '🛺', defaultCO2: 0, unit: 'km', prompt: 'How many km?' },
  { id: 'two_wheeler', label: 'Two-wheeler (petrol)', category: 'transport', icon: '🏍️', defaultCO2: 0, unit: 'km', prompt: 'How many km?' },
  { id: 'two_wheeler_ev', label: 'Two-wheeler (electric)', category: 'transport', icon: '⚡🏍️', defaultCO2: 0, unit: 'km', prompt: 'How many km?' },
  { id: 'cab', label: 'Ola/Uber cab', category: 'transport', icon: '🚕', defaultCO2: 0, unit: 'km', prompt: 'How many km?' },
  { id: 'cab_shared', label: 'Ola/Uber Share', category: 'transport', icon: '🚖', defaultCO2: 0, unit: 'km', prompt: 'How many km?' },
  { id: 'car_petrol', label: 'Personal car (petrol)', category: 'transport', icon: '🚗', defaultCO2: 0, unit: 'km', prompt: 'How many km?' },
  { id: 'local_train', label: 'Local train', category: 'transport', icon: '🚆', defaultCO2: 0, unit: 'km', prompt: 'How many km?' },
  { id: 'walk', label: 'Walking', category: 'transport', icon: '🚶', defaultCO2: 0, unit: 'km' },
  { id: 'cycle', label: 'Cycling', category: 'transport', icon: '🚲', defaultCO2: 0, unit: 'km' },
  // Food
  { id: 'veg_thali', label: 'Veg Thali', category: 'food', icon: '🍛', defaultCO2: 0.45, unit: 'meal' },
  { id: 'chicken_thali', label: 'Chicken Thali', category: 'food', icon: '🍗', defaultCO2: 1.4, unit: 'meal' },
  { id: 'mutton_thali', label: 'Mutton Thali', category: 'food', icon: '🍖', defaultCO2: 3.8, unit: 'meal' },
  { id: 'fish_thali', label: 'Fish Thali', category: 'food', icon: '🐟', defaultCO2: 0.9, unit: 'meal' },
  { id: 'street_food', label: 'Street food / Chaat', category: 'food', icon: '🥘', defaultCO2: 0.3, unit: 'meal' },
  { id: 'home_cooked', label: 'Home cooked', category: 'food', icon: '🏠', defaultCO2: 0.3, unit: 'meal' },
  { id: 'food_delivery', label: 'Swiggy/Zomato order', category: 'food', icon: '📱', defaultCO2: 0.5, unit: 'order' },
  // Energy
  { id: 'electricity', label: 'Electricity units', category: 'energy', icon: '⚡', defaultCO2: 0, unit: 'kWh', prompt: 'How many kWh?' },
  { id: 'lpg', label: 'LPG cylinder (14kg)', category: 'energy', icon: '🔥', defaultCO2: 29.5, unit: 'cylinder' },
  // Shopping
  { id: 'clothing', label: 'Clothing item', category: 'shopping', icon: '👕', defaultCO2: 12, unit: 'item' },
  { id: 'phone', label: 'Smartphone', category: 'shopping', icon: '📱', defaultCO2: 55, unit: 'item' },
  { id: 'laptop', label: 'Laptop', category: 'shopping', icon: '💻', defaultCO2: 320, unit: 'item' },
  { id: 'ac', label: 'Air conditioner', category: 'shopping', icon: '❄️', defaultCO2: 200, unit: 'item' },
]
